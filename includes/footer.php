		...
		<div class="footer_line">
			<div class="container">
				<div class="col-md-12">
					<div class="row">
						<div class="on_me">
							<a href="about.php">Информация о нас</a>
						</div>
						<div class="soc_buttons">
							<a href="https://vk.com/id160640085"><i class="fa fa-vk" aria-hidden="true"></i></a>
							<a href="https://ok.ru/profile/522330655452"><i class="fa fa-odnoklassniki" aria-hidden="true"></i></a>
							<a href="https://www.facebook.com/profile.php?id=100015998462417"><i class="fa fa-facebook" aria-hidden="true"></i></a>
						</div>
					</div>
				</div>
			</div>
